...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <ul class="list-group list-group-flush">
                <?php if (empty($komponen)): ?>
                    <li class="list-group-item">Belum ada komponen gaji yang diatur.</li>
                <?php else: ?>
        ...
        <div class="card-footer"><a href="<?= site_url('admin/penggajian') ?>" class="btn btn-secondary">Kembali</a></div>
    </div>
</div>
<?= $this->endSection() ?>